...
public class PainelAnaliseQuantitativa {
	...
	public JScrollPane analiseQuantitativa() {
		...
		JLabel TextProposta= new JLabel("validação da proposta");
		...
		JLabel TextDocumento = new JLabel("validação da documento");
		...
		JLabel TextComprovante = new JLabel("validação do comprovante");
		...
		JLabel TextExames = new JLabel("validação da Exames");
		...
		scrollAnaliseQuantitativa.setBounds(20, 115, 310, 450);
