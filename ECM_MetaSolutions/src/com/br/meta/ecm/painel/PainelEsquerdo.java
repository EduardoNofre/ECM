...
public class PainelEsquerdo extends JPanel {
	...
	public PropriedadeImagem changeImgEsquerda() throws IOException {
		...
		dropTargetEsquerdo = new DropTarget(addImagemPainelEsquerdo, DnDConstants.ACTION_MOVE,FramePrincipal.ecmView);
	...
	public PainelEsquerdo esquerdoPrincipal(FramePrincipal ecmView) throws IOException {
