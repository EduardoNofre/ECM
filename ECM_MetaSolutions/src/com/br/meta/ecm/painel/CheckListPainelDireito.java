...
public class CheckListPainelDireito extends JPanel{	
	...
	CheckListPainelDireito painelDireito = null;

	CheckListPainelDireito painelDireitaAddComponentesZoomRotate = null;
	...
	public CheckListPainelDireito() {

	}

	public CheckListPainelDireito(JViewport viewport) {
	...
	public PropriedadeImagem changeImgDireita() throws IOException {
		...
		CheckListPainelDireito.addImagemPainelDireito.setName("Direita");
		
		dropTargetDireito = new DropTarget(addImagemPainelDireito, DnDConstants.ACTION_MOVE,CheckListFrame.checkListFrame);
	...
	public CheckListPainelDireito componentesZoomRotate() throws IOException {
		...
		new ChangeListener() {
			...
			public void stateChanged(ChangeEvent e) {
				...
				CheckListPainelDireito.scrollpanelAddControleDireito.setAutoscrolls(true);

				CheckListPainelDireito.scrollpanelAddControleDireito.setName("compareDireita");

				CheckListPainelDireito.scrollpanelAddControleDireito.setBounds(840, 250, 500, 700);

				CheckListPainelDireito.scrollpanelAddControleDireito.setAlignmentX(-1000);

				CheckListPainelDireito.scrollpanelAddControleDireito.setAlignmentY(-1500);
		...
		new ChangeListener() {
			...
			public void stateChanged(ChangeEvent e) {
				...
				CheckListPainelDireito.scrollpanelAddControleDireito.setName("compareImagensPainel01");

				CheckListPainelDireito.scrollpanelAddControleDireito.setBounds(840, 250, 500, 700);

				CheckListPainelDireito.scrollpanelAddControleDireito.setAlignmentX(10);

				CheckListPainelDireito.scrollpanelAddControleDireito.setAlignmentY(10);
		...
		painelDireito.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(EtchedBorder.RAISED, Color.WHITE, Color.WHITE), "                              Zoom               Painel Direito                       rotação"));
	...
	public CheckListPainelDireito direitaPrincipalChk(CheckListFrame ecmView) throws IOException {

		getAddImagemPainelDireito = this.changeImgDireita();

		CheckListPainelDireito.scrollpanelAddControleDireito.setViewport(viewport);

		dropTargetDireito = new DropTarget(getAddImagemPainelDireito, DnDConstants.ACTION_MOVE,ecmView);

		painelDireito= new CheckListPainelDireito(viewport);

		viewport.setView(dropTargetDireito.getComponent());

		CheckListPainelDireito.scrollpanelAddControleDireito.setBounds(840, 250, 500, 700);

		CheckListPainelDireito.getAddImagemPainelDireito.setName("Direita");

		painelDireitaAddComponentesZoomRotate = this.componentesZoomRotate();

		getAddImagemPainelDireito.setScale(14);
